...
class PriceBot:
    def __init__(self, token):
        ...
        self.updater = Updater(token=token, use_context=True)  # Инициализация Updater
    ...
    def handle_message(self, update, context):
        ...
        if text == 'Узнать актуальную цену':
            ...
            context.bot.send_message(chat_id=update.effective_chat.id, text='Нажмите кнопку "Узнать актуальную цену" для получения актуальной цены.')
